...
url_to_scrape = 'https://www.stclaircollege.ca/programs/paralegal-accelerated' #Replace the url with the one you want to scrape(course)


# Define the attributes of the main div you want to extract
div_attributes = {'data-history-node-id': '10958', 'about': '/programs/paralegal-accelerated'} # Change the id and about by clicking on inspect
